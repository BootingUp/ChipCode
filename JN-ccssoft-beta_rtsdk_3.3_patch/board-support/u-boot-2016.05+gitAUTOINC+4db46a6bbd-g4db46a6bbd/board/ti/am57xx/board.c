...
#elif CONFIG_JN_MINIVB
    #define BOARD_NAME "JN-miniVB"
    #define PADCONF_ARRAY core_padconf_array_JN_miniVB
    #include "JN-miniVB_mux_data.h"
#elif CONFIG_JN_CCSSOFT_BETA
    #define BOARD_NAME "JN-ccssoft-beta"
    #define PADCONF_ARRAY core_padconf_array_JN_ccssoft_beta
    #include "JN-ccssoft-beta_mux_data.h"
#else
